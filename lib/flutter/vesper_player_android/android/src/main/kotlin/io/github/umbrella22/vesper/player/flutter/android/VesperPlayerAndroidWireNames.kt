...
import io.github.umbrella22.vesper.player.android.VesperTrackSupportReason
import io.github.umbrella22.vesper.player.android.VesperTrackSupportSource
import io.github.umbrella22.vesper.player.android.VesperTrackSupportStatus
...
private fun io.github.umbrella22.vesper.player.android.VesperExternalSubtitleSource.toPublicMap(): Map<String, Any?> =
    mapOf(
        "id" to id,
        "uri" to uri,
...
internal fun io.github.umbrella22.vesper.player.android.VesperPlayerDrmConfiguration.toMap(): Map<String, Any?> =
    mapOf(
