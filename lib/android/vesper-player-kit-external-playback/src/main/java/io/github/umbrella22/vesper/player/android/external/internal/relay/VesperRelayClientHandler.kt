...
import io.github.umbrella22.vesper.player.android.external.internal.relay.ffmpeg.VesperRelayIOException
...
internal class VesperRelaySourceRelay(
    ...
    private fun relaySource(
        source: io.github.umbrella22.vesper.player.android.VesperPlayerSource,
        headOnly: Boolean,
        range: ByteRangeRequest?,
        output: OutputStream,
    ) {
