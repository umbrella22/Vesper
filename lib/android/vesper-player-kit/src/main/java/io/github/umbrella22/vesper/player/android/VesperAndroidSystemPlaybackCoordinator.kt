...
private fun VesperSystemPlaybackMetadata.toMediaMetadata(): MediaMetadata {
    val extras =
        Bundle().apply {
            putBoolean("io.github.umbrella22.vesper.player.IS_LIVE", isLive)
            durationMs?.let { putLong("io.github.umbrella22.vesper.player.DURATION_MS", it) }
            contentUri?.let { putString("io.github.umbrella22.vesper.player.CONTENT_URI", it) }
        }
...
private const val ACTION_START_SYSTEM_PLAYBACK_SERVICE =
    "io.github.umbrella22.vesper.player.android.action.START_SYSTEM_PLAYBACK_SERVICE"
private const val ACTION_SYSTEM_SEEK_BACK = "io.github.umbrella22.vesper.system.seek_back"
private const val ACTION_SYSTEM_SEEK_FORWARD = "io.github.umbrella22.vesper.system.seek_forward"
