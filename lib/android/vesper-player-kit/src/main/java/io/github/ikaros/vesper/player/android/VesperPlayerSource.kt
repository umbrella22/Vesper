...
data class VesperPlayerSource(
    ...
    companion object {
        fun local(uri: String, label: String): VesperPlayerSource =
            VesperPlayerSource(
                uri = uri,
                label = label,
        ...
        fun hls(uri: String, label: String): VesperPlayerSource =
            remote(uri = uri, label = label, protocol = VesperPlayerSourceProtocol.Hls)

        fun dash(uri: String, label: String): VesperPlayerSource =
            remote(uri = uri, label = label, protocol = VesperPlayerSourceProtocol.Dash)
