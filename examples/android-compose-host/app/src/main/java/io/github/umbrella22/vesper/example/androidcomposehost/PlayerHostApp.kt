...
private fun ExampleSelectionSheetWithTracks(
    ...
    playbackRateControlsEnabled: Boolean,
    onOpenSheet: (ExamplePlayerSheet) -> Unit,
    onSelectQuality: (io.github.umbrella22.vesper.player.android.VesperAbrPolicy) -> Unit,
    onSelectAudio: (io.github.umbrella22.vesper.player.android.VesperTrackSelection) -> Unit,
    onSelectSubtitle: (io.github.umbrella22.vesper.player.android.VesperTrackSelection) -> Unit,
