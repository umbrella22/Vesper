...
OPENSSL_SOURCE_ARCHIVE="${VESPER_ANDROID_OPENSSL_SOURCE_ARCHIVE:-$(vesper_ffmpeg_source_cache_path "$OPENSSL_ARCHIVE_NAME")}"
...
LIBXML2_SOURCE_ARCHIVE="${VESPER_ANDROID_LIBXML2_SOURCE_ARCHIVE:-$(vesper_ffmpeg_source_cache_path "$LIBXML2_ARCHIVE_NAME")}"
