package io.github.ikaros.vesper.fixture.androidaarconsumer
    ...
    fun rawAarsPackageRegistryFragmentsAndNativeLibraries() {
        ...
        assertEquals(
            setOf(
                ...
                "io.github.ikaros.vesper.decoder-mediacodec.json",
                "io.github.ikaros.vesper.source-normalizer-ffmpeg.json",
            ),
            registryFiles,
        )
