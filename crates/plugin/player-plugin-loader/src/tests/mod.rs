...
use player_plugin::{
    ...
    NativeFrameMetadata, NativeFramePipelineProfile, NativeFrameReleaseTracking, NativeHandleKind,
    OutputFormat, PipelineEvent, ProcessorCapabilities, ProcessorError, ProcessorOutput,
    ProcessorProgress, SourceNormalizerError, SourceNormalizerNormalizeLevel,
