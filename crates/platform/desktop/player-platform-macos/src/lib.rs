...
const MACOS_NATIVE_FRAME_DECODER_DRAIN_RETRY_INTERVAL: Duration = Duration::from_millis(5);
const MACOS_NATIVE_FRAME_WORKER_SHUTDOWN_TIMEOUT: Duration = Duration::from_secs(2);
const MACOS_NATIVE_FRAME_WORKER_SHUTDOWN_POLL_INTERVAL: Duration = Duration::from_millis(5);
